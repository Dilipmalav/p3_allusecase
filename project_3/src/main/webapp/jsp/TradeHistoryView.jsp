...
<body class="hm">
	...
	<div>
		...
		<form action="<%=ORSView.TRADEHISTORY_CTL%>" method="post">
			<jsp:useBean id="dto" class="in.co.rays.project_3.dto.TradeHistoryDTO"
						...
						<div class="card-body">
							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" class="form-control" name="userId"
										...
										oninput="handleAlphaNumInput(this, 'userIdError', 15, 5)"
											onblur="handleAlphaNumInput(this, 'userIdError', 15, 5)"
							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" id="datepicker5" name="startDate"
                      ...
                      <span class="pl-sm-5"><b>EndDate</b> <span
							...
							<div class="col-sm-12">
								<div class="input-group">
									...
									<input type="text" id="datepicker6" name="endDate"
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									...
									style="font-size: 17px" value="<%=TradeHistoryCtl.OP_CANCEL%>">
							...
							<div class="text-center">
								...
								<input type="submit" name="operation"
									class="btn btn-success btn-md" style="font-size: 17px"
									value="<%=TradeHistoryCtl.OP_SAVE%>"> <input
									type="submit" name="operation" class="btn btn-warning btn-md"
