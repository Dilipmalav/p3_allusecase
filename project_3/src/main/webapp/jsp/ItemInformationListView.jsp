...
<body class="hm">
	...
	<div></div>
	<div>
		<form class="pb-5" action="<%=ORSView.ITEMINFORMATION_LIST_CTL%>"
			method="post">
			<jsp:useBean id="dto"
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="purchaseDate" placeholder="Enter  purchaseDate"
				...
				<div align="center">
					<input type="submit" class="btn btn-primary btn-md"
						...
						name="operation" value="<%=ItemInformationListCtl.OP_RESET%>">
				</div>
			</div>
			<br>
