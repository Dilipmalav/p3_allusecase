			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="stockSymbol"
						placeholder="Enter stockSymbol" maxlength="16"
						class="form-control" id="number"
						oninput="handleLetterInput(this, 'stockSymbolError', 25)"
						onblur="validateLetterInput(this, 'stockSymbolError', 25)"
				...
				<div class="col-sm-2"><%=HTMLUtility.getList1("analysisType", String.valueOf(dto.getAnalysisType()), map)%></div>
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: blue;">
							...
							<th width="20%" class="text">EndDate</th>
