		...
		<form class="pb-5" action="<%=ORSView.STAFFMEMBER_LIST_CTL%>"
			...
			<div class="row">
				...
				<div class="col-sm-2">
					...
					<div class="col-sm-2">
					<input type="text" name="joiningDate" placeholder="Enter joiningDate"
						id="datepicker2" class="form-control" readonly="readonly"
						value="<%=ServletUtility.getParameter("joiningDate", request)%>">
				</div>

				<div class="col-sm-2"><%=HTMLUtility.getList1("division", String.valueOf(dto.getDivision()), map)%></div>

				<div class="col-sm-2">
					<input type="text" name="previousEmployer" placeholder="Enter previousEmployer"
