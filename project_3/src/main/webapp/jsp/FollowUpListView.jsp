	...
	<div>
		<form class="pb-5" action="<%=ORSView.FOLLOWUP_LIST_CTL%>"
			...
			<div class="row">
              ...
              <div class="col-sm-2"><%=HTMLUtility.getList1("client", String.valueOf(dto.getClient()), map)%></div>
				
              <div class="col-sm-2"><%=HTMLUtility.getList1("physician", String.valueOf(dto.getPhysician()), map1)%></div>
