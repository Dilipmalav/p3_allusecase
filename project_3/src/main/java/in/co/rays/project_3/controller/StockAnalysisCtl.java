...
public class StockAnalysisCtl extends BaseCtl {
	...
	protected boolean validate(HttpServletRequest request) {
		...
		if (DataValidator.isNull(request.getParameter("stockSymbol"))) {
			...
			pass = false;
    	}  else if (!DataValidator.validateAlphanumeric(request.getParameter("stockSymbol"))) {
			request.setAttribute("stockSymbol", PropertyReader.getValue("Enter only alphanumric"));
			pass = false;
		}
