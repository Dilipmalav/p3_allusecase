...
public class DataUtility {
	...
	public static Double getDoubleData(Object val) {
	    ...
	    return 0.0; // Default value for null input
	}
	...
	public static double parseDouble(String str) {
		try {
			return Double.parseDouble(str); // Java ka built-in method use kiya
		} catch (NumberFormatException e) {
			System.out.println("Invalid number format: " + str);
			return 0.0; // Agar conversion fail ho to default value return karein
		}
	}
